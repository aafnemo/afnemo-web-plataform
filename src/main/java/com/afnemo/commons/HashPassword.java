 ...
 * @date: 20/04/2019
 * @filename: HashPassword.java
 * @Copyright (C) 2019 Asociación Afrocultural Neftalí Mosquera (afnemo)
 * @Fuente: https://gist.github.com/jtan189/3804290
 */
...
public class HashPassword {
	...
	private HashPassword() {
		throw new IllegalStateException("Hash Password class");
	}
	/**
	...
	private static String toHex(byte[] array) {
		...
		if (paddingLength > 0)
			return String.format("%d%dd", 0, paddingLength) + hex;
		else
			return hex;
	}
}
